...
export function ReservationCancelled({
  ...
  return (
    <Html>
      <Head />
      <Preview>Your reservation on {formattedDate} has been cancelled</Preview>
      <Body style={main}>
        <Container style={container}>
          <Heading style={h1}>Reservation Cancelled</Heading>
          <Text style={text}>Hello {userName},</Text>
          <Text style={text}>
            We want to let you know that the following court reservation has
            been cancelled:
          </Text>
          ...
          <Hr style={hr} />
          <Text style={footer}>
            Feel free to book a new reservation whenever you&apos;d like to
            play.
          </Text>
        </Container>
      </Body>
