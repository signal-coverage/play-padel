      ...
      <div className="absolute inset-0 flex flex-col justify-end p-6 sm:p-8">
        <div className="max-w-2xl">
          ...
          {ctaLabel && (
            <Link
              href={href}
              className="inline-flex w-fit items-center gap-2 rounded-sm bg-primary px-6 py-2.5 text-sm font-bold text-primary-foreground transition-colors hover:bg-primary/90 active:scale-[0.96]"
            >
              {ctaLabel}
