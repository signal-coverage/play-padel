...
import { getRecentNutritionPatients } from "@/app/actions/nutrition";

export function NutritionPage() {
  const [patientSearch, setPatientSearch] = useState("");

  const recentQuery = useQuery({
    queryKey: ["nutrition-recent-patients"],
    queryFn: () => getRecentNutritionPatients(),
  });
                ...
                <div className="divide-y">
                  {recentPatients.map((patient) => (
                    <Link
                      ...
                      href={`/dashboard/nutrition/${patient.patientId}`}
        ...
        <div className="flex-1 min-w-0">
          <Card className="h-full flex flex-col items-center justify-center">
            <div className="text-center space-y-2 p-8">
              ...
              <p className="text-xs text-muted-foreground">
                Choose a patient from the sidebar to view their nutrition chart.
              </p>
            </div>
          </Card>
        </div>
