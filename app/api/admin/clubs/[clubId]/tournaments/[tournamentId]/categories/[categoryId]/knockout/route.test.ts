...
function makeRequest() {
  return new Request(
    "http://localhost/api/admin/clubs/club_1/tournaments/tourney_1/categories/cat_1/knockout",
...
describe("GET /api/admin/clubs/[clubId]/tournaments/[tournamentId]/categories/[categoryId]/knockout", () => {
  ...
  it("returns the category's knockout matches when owned", async () => {
    ...
    listKnockoutMatchesForCategoryMock.mockResolvedValue([{ id: "match_1" }]);
