...
function makeRequest() {
  return new Request(
    "http://localhost/api/admin/clubs/club_1/tournaments/tourney_1/categories/cat_1/knockout/generate",
    { method: "POST" },
...
describe("POST /api/admin/clubs/[clubId]/tournaments/[tournamentId]/categories/[categoryId]/knockout/generate", () => {
  ...
  it("generates the knockout bracket with the route's clubId and the admin's userId", async () => {
