...
// Opt-in only (ANALYZE=true next build) — must never run or affect a
// normal `next build`/`next dev`. Used to find which dependency's own
// down-leveled bundle was behind the landing page's "Legacy JavaScript"
// PageSpeed finding.
